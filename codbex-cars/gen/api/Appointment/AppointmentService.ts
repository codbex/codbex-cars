...
const validationModules = await Extensions.loadExtensionModules("codbex-cars-Appointment-Appointment", ["validate"]);
...
class AppointmentService {
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-cars/gen/api/Appointment/AppointmentService.ts/" + entity.Id);
