...
export class CarModelRepository {
    ...
    private async triggerEvent(data: CarModelEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-cars-Settings-CarModel", ["trigger"]);
        ...
        producer.topic("codbex-cars-Settings-CarModel").send(JSON.stringify(data));
    }
}
