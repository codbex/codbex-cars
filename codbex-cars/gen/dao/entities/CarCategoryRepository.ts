...
export class CarCategoryRepository {
    ...
    private async triggerEvent(data: CarCategoryEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-cars-entities-CarCategory", ["trigger"]);
        ...
        producer.topic("codbex-cars-entities-CarCategory").send(JSON.stringify(data));
    }
}
